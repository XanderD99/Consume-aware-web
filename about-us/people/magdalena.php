<h2>Magdalena Iordache-Platis</h2>
    ...
    <div class="">
        <div class="row valign-wrapper">
            <div class="col s2 center">
                <img height="125" width="125" src="/assets/images/people/magdalena.jpg" alt="Magdalena Iordache-Platis" class="circle responsive-img"> <!-- notice the "circle" class -->
            </div>
            <div class="col s10">
                <span class="black-text">
                Professor of Marketing, Micro and Macroeconomics at the Faculty of Business and Administration, having an experience of more than 25 years of teaching and research.  Involved in higher education management for more than 16 years. Vice - rector in charge with quality assurance and business relationship since 2011. 
                </span>
            </div>
        </div>
    </div>
...
<p>Customer relationship marketing and management, customer capital, business strategies, academic leadership, quality assurance management, university and industry cooperation, entrepreneurial university strategy, </p>
