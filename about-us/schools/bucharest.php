...
<div class="row">
    <div class="s12 m6 l4 xl3 col">
        <div class="our-team">
            <div class="picture">
                <img class="img-fluid" src="/assets/images/people/magdalena.jpg">
            </div>
            ...
            <ul class="social">
                ...
                <li><a href="/about-us/detail.php?name=magdalena">Read more</a></li>
            </ul>
        </div>
    </div>
    <div class="s12 m6 l4 xl3 col">
        <div class="our-team">
            <div class="picture">
                <img class="img-fluid" src="/assets/images/people/diana.png">
            </div>
            <div class="team-content">
                <h5 class="name">Diana Ionita</h3>
                    <h6 class="title">University of Bucharest</h4>
            </div>
            <ul class="social">
                <li><a href="mailto:diana.ionita@lls.unibuc.ro">mail</a></li>
                <li><a href="/about-us/detail.php?name=diana">Read more</a></li>
            </ul>
        </div>
    </div>
    <div class="s12 m6 l4 xl3 col">
        <div class="our-team">
            <div class="picture">
                <img class="img-fluid" src="/assets/images/people/diara.png">
            </div>
            <div class="team-content">
                <h5 class="name">Daria Protopopescu</h3>
                    <h6 class="title">University of Bucharest</h4>
            </div>
            <ul class="social">
                <li><a href="mailto:daria.protopopescu@lls.unibuc.ro">mail</a></li>
                <li><a href="/about-us/detail.php?name=diara">Read more</a></li>
            </ul>
        </div>
    </div>
</div> 