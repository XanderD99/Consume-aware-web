...
<div class="row">
    ...
    <div class="s12 m6 l4 xl3 col">
        <div class="our-team">
            <div class="picture">
                <img class="img-fluid" src="/assets/images/people/marta-grybs.png">
            </div>
            <div class="team-content">
                <h5 class="name">Marta Grybs</h3>
                    <h6 class="title">University of Economics in Katowice</h4>
            </div>
            <ul class="social">
    ...
    <div class="s12 m6 l4 xl3 col">
        <div class="our-team">
            ...
            <div class="team-content">
                <h5 class="name">Justyna Matysiewicz</h3>
                    <h6 class="title">University of Economics in Katowice</h4>
            </div>
            <ul class="social">
    ...
    <div class="s12 m6 l4 xl3 col">
        <div class="our-team">
            ...
            <div class="team-content">
                <h5 class="name">Agnieszka Tetla</h3>
                    <h6 class="title">University of Economics in Katowice</h4>
            </div>
            <ul class="social">
