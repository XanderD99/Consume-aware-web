<div id="teacherSub" class="hide center-align">
    <div class="row">
        <button id="instruction" class="waves-effect waves-teal cyan btn-large">instruction</button>
  ...
  <div id="part1Sub" class="hide row center-align">
    <button id="chapter1" class="waves-effect waves-teal  btn-large">
      chapter1
    </button>
    <button id="chapter2" class="waves-effect waves-teal  btn-large">
      chapter2
    </button>
    <button id="chapter3" class="waves-effect waves-teal  btn-large">
      chapter3
    </button>
  </div>

  <div id="part2Sub" class="hide row center-align">
    <button id="chapter4" class="waves-effect waves-teal btn-large">
      chapter4
    </button>
    <button id="chapter5" class="waves-effect waves-teal btn-large">
      chapter5
    </button>
    <button id="chapter6" class="waves-effect waves-teal btn-large">
      chapter6
    </button>
  </div>

  <div id="part3Sub" class="hide row center-align">
    <button id="chapter7" class="waves-effect waves-teal btn-large">
      chapter7
    </button>
    <button id="chapter8" class="waves-effect waves-teal btn-large">
      chapter8
    </button>
    <button id="chapter9" class="waves-effect waves-teal btn-large">
      chapter9
    </button>
    <button id="chapter10" class="waves-effect waves-teal btn-large">
      chapter10
    </button>
    <button id="chapter11" class="waves-effect waves-teal btn-large">
      chapter11
    </button>
  </div>
