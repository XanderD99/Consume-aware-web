...
<div id="studentSub" class="center-align">
    <div class="row">
      <a href="#"><button id="howTo" class="waves-effect waves-teal cyan btn-large study-button">How to</button></a>
      <a href="#"><button id="bookStudent" class="waves-effect waves-teal btn-large study-button">Book</button></a>
      <a href="#"><button id="appStudent" class="waves-effect waves-teal btn-large study-button">App </button></a>
    </div>
    <div class="row">
